...
/************************************************************************************************/
UINT usbx_demo_device_storage_init(VOID);
UINT usbx_demo_device_storage_uninit(VOID);
...
static UCHAR ram_disk_memory[RAM_DISK_SIZE];
...
/************************************************************************************************/
/**  usbx_demo_device_storage_uninit                                                            */
/**                                                                                             */
/**  Stop the demo worker threads created by                                                    */
/**  usbx_demo_device_storage_uninit so the  RTOS sample can be shut down cleanly.              */
/**                                                                                             */
/************************************************************************************************/
UINT usbx_demo_device_storage_uninit(VOID)
{
...
UINT status = UX_SUCCESS;
    ...
    ux_utility_memory_copy(data_pointer, ram_disk_memory + lba * RAM_DISK_BLOCK_LENGTH,
...
UINT status =  UX_SUCCESS;
    ...
    ux_utility_memory_copy(ram_disk_memory + lba * RAM_DISK_BLOCK_LENGTH, data_pointer,
                           number_blocks * RAM_DISK_BLOCK_LENGTH);
