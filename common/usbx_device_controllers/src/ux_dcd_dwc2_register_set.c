...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _ux_dcd_dwc2_register_set                           PORTABLE C      */
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*  DESCRIPTION                                                           */
/*                                                                        */
/*    This function sets a bit in a register of the DWC2.                 */
/*                                                                        */
/*  INPUT                                                                 */
/*                                                                        */
/*    dcd_dwc2                               Pointer to device controller */
/*    dwc2_register                          Register to set              */
/*    value                                  Value to set                 */
/*                                                                        */
/*  OUTPUT                                                                */
/*                                                                        */
...
VOID  _ux_dcd_dwc2_register_set(UX_DCD_DWC2 *dcd_dwc2, ULONG dwc2_register, ULONG value)
{
    ...
    *((ULONG *) (dcd_dwc2 -> ux_dcd_dwc2_base + dwc2_register)) |=  value;
    return;
}
